...
-- ─────────────────────────────────────────
-- HELPER FUNCTION (needs players table)
-- ─────────────────────────────────────────
...
create policy "Admins have full access to player_whitelist"
  on player_whitelist for all using (is_admin()) with check (is_admin());
...
create policy "Admins have full access to training_sessions"
  on training_sessions for all using (is_admin()) with check (is_admin());
...
create policy "Admins have full access to attendance"
  on attendance for all using (is_admin()) with check (is_admin());
...
create policy "Admins have full access to polls"
  on polls for all using (is_admin()) with check (is_admin());
create policy "Players can view active polls"
  on polls for select using (auth.role() = 'authenticated');

-- poll_options
create policy "Admins have full access to poll_options"
  on poll_options for all using (is_admin()) with check (is_admin());
create policy "Players can view poll_options"
  on poll_options for select using (auth.role() = 'authenticated');

-- poll_votes
create policy "Admins have full access to poll_votes"
  on poll_votes for all using (is_admin()) with check (is_admin());
create policy "Players can view poll_votes"
  on poll_votes for select using (auth.role() = 'authenticated');
...
create policy "Admins have full access to player_stats"
  on player_stats for all using (is_admin()) with check (is_admin());
